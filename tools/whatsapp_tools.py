...
def send_whatsapp_message(
    ...
    """
    Send a WhatsApp text message to a specific contact or chat.
    """
    ...
    return (
        f"WhatsApp message sent successfully to "
        f"{result['chat']}."
    )
...
def send_whatsapp_attachment(
    ...
    """
    Send one or more files to a WhatsApp contact.
    The message is used as the attachment caption.
    """

    whatsapp = WhatsAppTool()

    result = whatsapp.send_attachment(
        contact=contact,
        message=message,
        file_path=file_path,
    )
    ...
    return (
        f"Attachment(s) sent successfully to "
        f"{result['chat']}."
    )
...
def read_whatsapp_messages(
    ...
    """
    Open a specific WhatsApp chat and read the currently
    visible messages using OCR. Returns the visible message
    text from the chat.
    """
    ...
    if not result.get("success"):
        return (
            f"Failed to read messages from "
            f"{contact}."
        )
